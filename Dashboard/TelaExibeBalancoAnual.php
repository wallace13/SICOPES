...
?>
    <table border="1" cellpadding="5" width="800">
        <thead>
            <tr>
                <th colspan="8">Balanço do <?php echo $_POST['tipo'];?> - Balanço Anual de <?php echo $_SESSION['ano'];?></th>
            </tr>
            <tr>
    ...
    <?php } ?>
    <div class="buttons">
        <a class="btn-medium" id="cadastrar" href="TelaConsultaBalancoAnual.php">Voltar</a>

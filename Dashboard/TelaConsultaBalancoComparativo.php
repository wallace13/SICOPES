<?php include ("../views/header.php") ?>
    <h4>Pesquisa de Satisfação - Balanço Comparativo</h4>

    <form action="TelaExibeBalacoComparativo.php" method="post">
        <div class="voto">
        ...
        <div class="voto">
            <p>Selecione os meses para comparação:</p>
                <select id="meses" name="mes" required>
                    <option></option>
                ...
                <select id="meses" name="mes2" required>
                    <option></option>
                    <option value="01">Janeiro</option>
                    <option value="02">Fevereiro</option>
                    <option value="03">Março</option>
